...
class FavoritesControllerTest  extends TestCase
{
    ...
    public function testAddFavoriteDoesNotDuplicateRepository(): void
    {
        ...
        $this->service->addFavorite($userId, $repoId);
        $this->service->addFavorite($userId, $repoId); // drugi raz
    ...
    public function testAddFavoritesForMultipleUsers(): void
    {
        ...
        $this->assertEquals([111], $this->service->getFavorites($user1));
        $this->assertEquals([222], $this->service->getFavorites($user2));
    }
}